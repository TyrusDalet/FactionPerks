...
local reportAAM = utils.makeAAMReporter(FACTION_DISPLAY_NAME, perkTable, getHHRank)
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Great Houses", "House Hlaalu", 1},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Great Houses", "House Hlaalu", 2},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Great Houses", "House Hlaalu", 3},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Great Houses", "House Hlaalu", 4},
