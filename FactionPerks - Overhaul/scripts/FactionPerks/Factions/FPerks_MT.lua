...
local reportAAM = utils.makeAAMReporter(FACTION_DISPLAY_NAME, perkTable, getMTRank)
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Morag Tong", 1},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Morag Tong", 2},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Morag Tong", 3},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Morag Tong", 4},
