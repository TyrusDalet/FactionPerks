...
local DEFAULTS = {
    ...
    leaderTrainingEnabled = true,
    debugVerbosity = 0,
}

--- Registers the FactionPerks settings page and persistent settings group.
local function init()
    ...
    interfaces.Settings.registerGroup {
        ...
        settings = {
            ...
            {
                key = "leaderTrainingEnabled",
                name = "leaderTrainingEnabledName",
                description = "leaderTrainingEnabledDescription",
                default = DEFAULTS.leaderTrainingEnabled,
                renderer = "checkbox",
            },
            {
                key = "debugVerbosity",
