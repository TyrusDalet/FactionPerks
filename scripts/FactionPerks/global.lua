...
--- Applies temporary Hlaalu merchant disposition and Mercantile bonuses.
--- Uses global-only APIs, so player scripts send NPC/value payloads here.
--- @param data table Payload containing npc, disp, and merc fields.
...
--- Reverses temporary Hlaalu merchant disposition and Mercantile bonuses.
--- @param data table Payload containing npc, disp, and merc fields.
...
--- Permanently increases a merchant's barter gold for EEC perks.
--- @param data table Payload containing npc and amount.
...
--- Removes a previously applied EEC barter gold bonus, clamped at zero.
--- @param data table Payload containing npc and amount.
...
--- Sets a merchant's barter gold exactly, used by debug/maintenance commands.
--- @param data table Payload containing npc and amount.
