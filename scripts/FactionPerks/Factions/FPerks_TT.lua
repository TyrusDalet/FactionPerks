--[[
    ...
    Honoured Ancestors (P3+):
        ...
        Handled via actor.lua ping + player response pattern.
...
local reportAAM = utils.makeAAMReporter(FACTION_DISPLAY_NAME, perkTable, getTTRank)
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Tribunal Temple", 1},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Tribunal Temple", 2},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Tribunal Temple", 3},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Dunmeri Factions", "Tribunal Temple", 4},
