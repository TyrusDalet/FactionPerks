...
local reportAAM = utils.makeAAMReporter(FACTION_DISPLAY_NAME, perkTable, getTGRank)
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Imperial Factions", "Thieves Guild", 1},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Imperial Factions", "Thieves Guild", 2},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Imperial Factions", "Thieves Guild", 3},
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    category = {"FactionPerks", "Imperial Factions", "Thieves Guild", 4},
